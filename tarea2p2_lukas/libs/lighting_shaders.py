...
# shader para usar múltiples luces con texturas(piso , casas y arboles)
class MultipleLightTexturePhongShaderProgram:

    def __init__(self):
        #shaders están en archivos de texto independientes, se leen aquí
...
# shader para soportar geometría con color y múltiples luces(bola auto y postes)
class MultipleLightPhongShaderProgram:

    def __init__(self):
        # en archivos de texto independientes, aquí los leemos
